...
class FavouriteWidget extends StatefulWidget {
  final AsyncValue<List<Movie>> favMList;
  final AsyncValue<List<Movie>> favTvList;
  final AsyncValue<List<Movie>> favPList;
  const FavouriteWidget({super.key, required this.favMList, required this.favTvList, required this.favPList});
